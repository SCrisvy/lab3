...
<html>
    ...
    <body>
        ...
        <section id = "References" class = "page">
			...
			<article>
			<a href="http://localhost/lab3/ci4/public/news" >News</a>
			<br>
			<br>
			<a href="http://localhost/lab3/ci4/public/guest/create" >Guest form</a>
			<br>
			<br>
			<a href="http://localhost/lab3/ci4/public/guest" >List of Guests</a>
            <article>
        </section>
